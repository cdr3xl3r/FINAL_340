...
CREATE TABLE `maintainance` (
  `MAINT_NUM` int(5) unsigned zerofill NOT NULL,
  `MAINT_` varchar(45) NOT NULL,
  `MAINT_TYPE` double NOT NULL,
  PRIMARY KEY (`MAINT_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MAINTAINANCE  TABLE';
